...
faqs:
  - q: "How long is a typical GolfNow contract?"
    a: "GolfNow contracts typically come in 1-year, 2-year, and 3-year terms. Longer terms may offer more favorable initial pricing but lock courses into the relationship even if results don't materialize."
  - q: "Does GolfNow automatically renew?"
    a: "Yes. Most GolfNow contracts include automatic renewal clauses. If you don't provide written notice of cancellation within a specific window before the contract end date — often 30 to 90 days — the contract automatically renews for another full term."
  - q: "Can I exit a GolfNow contract early?"
    a: "Early termination is possible but usually involves fees calculated as a percentage of remaining contract value or a flat fee. Some contracts allow termination for cause with no fee. Over 100 courses left GolfNow in Q1 2025 alone, so exits are increasingly common and the process is well understood."
  - q: "Who owns customer data in a GolfNow agreement?"
    a: "GolfNow contracts typically mean the platform — not the golf course — owns the customer data generated through the booking relationship, including email addresses and booking histories. Always confirm data ownership and export rights before signing, as this directly affects your ability to run your own marketing and loyalty programs."
---
