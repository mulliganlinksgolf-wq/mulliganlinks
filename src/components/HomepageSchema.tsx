  ...
  const schema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'TeeAhead Eagle membership ($89/yr) beats GolfPass+ ($119/yr) on every metric: 250 bonus Fairway Points on signup, 1 complimentary round/yr (course-provided), always-on booking fee waiver, 2× points multiplier, 48hr priority booking, and a birthday credit.',
        },
      },
      {
        '@type': 'Question',
