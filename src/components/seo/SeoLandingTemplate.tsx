                  ...
                  {section.kind === "stats" && (
                    <div className="mt-8 grid sm:grid-cols-3 gap-8">
                      {section.stats.map(({ num, label, sub }) => (
                        <div
                          key={label}
                          className={`min-w-0 [container-type:inline-size] border-t pt-4 ${dark ? "border-[#E0A800]" : "border-[#0F3D2E]"}`}
                        >
                          <p
                            ...
                            style={{
                              fontSize: "clamp(24px, 15cqw, 64px)",
                              fontWeight: 400,
                            }}
                          >
                            {num}
                  ...
                  {section.kind === "comparison" && (
                    ...
                    >
                      <div
                        ...
                        className={`grid grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)] gap-3 px-4 sm:px-5 py-3.5 ${
                      ...
                      {section.rows.map((r, j) => (
                        <div
                          key={r.l}
                          className={`grid grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)] gap-3 px-4 sm:px-5 py-3.5 border-t items-center ${
                        ...
                        >
                          ...
                          <span
                            className={`text-[13px] ${dark ? "text-[#F4F1EA]/60" : "text-[#6B7770]"}`}
                          >
                            {r.a}
                          </span>
                          <span
        ...
        <section className="px-6 py-20 bg-[#FAF7F2] text-center border-t border-[#0F3D2E]/10">
          <FadeIn>
            <div className="max-w-2xl mx-auto space-y-5">
              ...
              >
                Ready to{" "}
                <em className="italic text-[#E0A800]">drop GolfNow?</em>
              </h2>
...
function SectionEyebrow({ label, dark }: { label: string; dark: boolean }) {
  ...
  return (
    <div className="flex items-baseline gap-3">
      ...
      <span
        className={`flex-1 h-px ${dark ? "bg-[#F4F1EA]/15" : "bg-[#0F3D2E]/10"}`}
      />
    </div>
  );
}
