...
export function BarterPage({ spotsRemaining, content = {} }: BarterPageProps) {
  ...
  const [presetKey, setPresetKey] = useState<
    "municipal" | "dailyfee" | "semiprivate" | "custom"
  >("dailyfee");

  const presets = {
    municipal: { label: "Municipal · $45", greenFee: 45, days: 280 },
    dailyfee: {
      label: `Daily fee · ${TYPICAL_PEAK_RATE_LABEL}`,
      greenFee: TYPICAL_PEAK_RATE,
      days: OPERATING_DAYS,
    },
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-14 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-base sm:text-lg text-[#F4F1EA]/78 leading-relaxed max-w-md">
                <strong className="text-[#F4F1EA]">This year alone.</strong>{" "}
                Adjust the sliders, the number updates as you drag.
              </p>
              ...
              <div className="mt-7 pt-5 border-t border-[#F4F1EA]/10">
                ...
                <ul className="flex flex-col gap-1.5">
                  {[
                    {
                      primary: `$${fiveYearCost.toLocaleString()}`,
                      label: "over five years, compounded",
                    },
                    {
                      primary: `${rounds.toLocaleString()}`,
                      label: `rounds of revenue per year, at $${greenFee}/round`,
                    },
                    {
                      primary: `${staff}×`,
                      label: `full-time staff at $50K/yr`,
                    },
                  ].map((row) => (
                    <li
                      key={row.label}
                      className="grid grid-cols-[minmax(96px,auto)_1fr] gap-3.5 items-baseline py-1"
                    >
                      <span
            ...
            <div className="bg-[#F4F1EA]/[0.04] border border-[#F4F1EA]/10 rounded-2xl p-6 sm:p-7 flex flex-col gap-5">
              ...
              >
                <input
                  ...
                  value={greenFee}
                  onChange={(e) => {
                    setGreenFee(Number(e.target.value));
                    setPresetKey("custom");
                  }}
              ...
              <p className="text-[11px] text-[#F4F1EA]/40 text-center font-mono tracking-[0.06em] leading-relaxed">
                ...
                Source · NGCOA member survey data and Golf Inc. industry
                analysis (2024). Actual barter arrangements vary by course
                agreement.
              </p>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  sub: null,
                  source: "NGCOA member reporting / Golf Inc. analysis",
                },
                {
                  num: "100+",
