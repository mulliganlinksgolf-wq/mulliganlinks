    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: `GolfNow charges courses in barter tee times (approximately 2 per day at discounted rates) rather than a flat monthly fee. Based on NGCOA member survey data and Golf Inc. industry analysis, at a typical ${TYPICAL_PEAK_RATE_LABEL} peak rate this costs the average daily-fee course approximately ${TYPICAL_ANNUAL_BARTER_LABEL} per year. High-volume courses at resort rates can lose ${HIGH_VOLUME_ANNUAL_BARTER_LABEL} or more annually.`,
          },
        },
        {
          '@type': 'Question',
            ...
            <FadeIn>
              <article className="space-y-10">
                <section className="space-y-4">
                  ...
                  <p className="text-base leading-[1.7] text-[#1A1A1A]/85">
                    In practice, those slots add up fast. At a typical {TYPICAL_PEAK_RATE_LABEL} peak rate across {OPERATING_DAYS} operating days, the average daily-fee course gives away <strong>{TYPICAL_ANNUAL_BARTER_LABEL} a year</strong>. High-volume courses at resort rates lose {HIGH_VOLUME_ANNUAL_BARTER_LABEL} or more.
                  </p>
                  <p className="text-base leading-[1.7] text-[#1A1A1A]/85">
                ...
                <section>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { q: "What is GolfNow's barter model?", a: `GolfNow's barter model requires partner courses to surrender approximately 2 tee times per day at discounted "Hot Deal" rates in exchange for their tee sheet software and marketplace listing. At a typical ${TYPICAL_PEAK_RATE_LABEL} peak rate, this costs the average daily-fee course about ${TYPICAL_ANNUAL_BARTER_LABEL} per year, and ${HIGH_VOLUME_ANNUAL_BARTER_LABEL} or more for high-volume courses.` },
