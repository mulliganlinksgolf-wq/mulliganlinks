...
export default async function MemberCardPage() {
  ...
  return (
    <div className="max-w-sm mx-auto">
      <div className="mb-6">
        <p className="text-[9px] uppercase tracking-[0.2em] text-[#aaa] font-sans mb-1">Member Card</p>
        <h1 className="text-2xl font-bold font-serif text-white italic">Your member card.</h1>
