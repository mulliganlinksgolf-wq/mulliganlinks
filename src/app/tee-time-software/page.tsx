...
export default function TeeTimeSoftwarePage() {
  return (
    <div className="min-h-screen bg-[#FAF7F2] flex flex-col">
      ...
      {/* Footer */}
      <footer className="bg-[#0F3D2E] border-t border-white/10 px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-6 text-sm text-[#F4F1EA]/60">
            ...
            <Link href="/best-tee-sheet-software" className="hover:text-[#F4F1EA] transition-colors">Best Tee Sheet Software</Link>
